...
@section('content')
    <article class="cl pd-20">
        <form action="" method="post" class="form form-horizontal" id="form-link-edit">
            {{csrf_field()}}
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->link_name}}" placeholder="请输入分类名称"  name="link_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>排序：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->link_order}}" placeholder="" name="link_order" style="width: 27%;">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->link_title}}" placeholder="请输入分类标题" name="link_title">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>链接url：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->link_url}}" placeholder="请输入关键词" name="link_url">
                </div>
            </div>
            <div class="row cl">
        ...
        $(function(){
            $("#form-link-edit").validate({
                ...
                submitHandler:function(form){
                    $(form).ajaxSubmit({
                        url:"{{url('admin/links/'.$data->link_id)}}",
                        type:'put',
