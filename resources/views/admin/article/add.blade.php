        ...
        <form class="form form-horizontal" id="form-article-add">
            ...
            <div class="row cl">
				...
				<select name="art_pid" class="select">
                    ...
                    @foreach($cate as $v)
                        <option value="{{$v->cate_id}}" data="{{$v->cate_pid}}">{{$v->_cate_name}}</option>
                    @endforeach
                </select>
				</span> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="" id="" name="art_author" style="width: 27%;">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div class="uploader-thum-container">
                        <input type="text" class="input-text" readonly id="art_thumb" name="art_thumb"/>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="art_desc" cols="" rows="" class="textarea"   nullmsg="备注不能为空！"></textarea>
